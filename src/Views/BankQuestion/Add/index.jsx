...
import { API_ENDPOINT, QUESTION_BANK, routePath } from "AppConstants";
...
const AddStudent = () => {
  ...
  const handleAdd = async (values) => {
    ...
    try {
      const response = await bankQuestionServices.add({ data: data });
  ...
  return (
    ...
    >
      ...
      <Grid item xs={12}>
        <Typography variant="h5">{strings.addBankQuestion}</Typography>
      </Grid>
