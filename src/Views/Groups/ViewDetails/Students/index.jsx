...
const ViewGroupStudents = ({ group }) => {
  ...
  const {
    ...
    key: [
      "groupStudentServices.getAll",
      { group: groupId, page, limit: pageSize },
    ],
    fetcher: () =>
      groupStudentServices.getAll({ group: groupId, page, limit: pageSize }),
    enabled: !!groupId,
  });
  ...
  const handleDeleteRow = async () => {
    ...
    try {
      await groupStudentServices.deleteById(selectedRow);
  ...
  return (
    <Box>
      ...
      <Button
        ...
        state={{
          navigateTo: `${routePath}groups/view/${groupId}/students`,
          group: groupId,
          level: group.level.id,
          subLevel: group.subLevel.id,
        }}
        variant="contained"
      >
        {strings.addStudent}
