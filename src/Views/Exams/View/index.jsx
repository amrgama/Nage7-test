      ...
      <Box>
        ...
        <DataGrid
          ...
          columns={[
            ...
            {
              headerName: strings.examDuration,
              field: accessor.duration,
              flex: 0.8,
              minWidth: 120,
              type: "number",
            },
              ...
              renderCell: (params) => (
                <Box className={classes.actionsContainer}>
                  <IconButton
                    ...
                    LinkComponent={Link}
                    to={`${routePath}exams/view/${params.id}`}
                  >
                    <VisibilityIcon />
                  </IconButton>
                  <IconButton
                    ...
                    LinkComponent={Link}
                    to={`${routePath}exam/edit/${params.id}`}
                  >
                    <EditIcon />
                  </IconButton>
                  <IconButton
