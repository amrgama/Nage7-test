...
const EditOfflineExam = () => {
  ...
  const {
    ...
    resolver: yupResolver(Validation, { stripUnknown: true }),
    mode: "all",
  });
  ...
  const { isLoading: loadingExam } = useQueryService({
    ...
    >
        ...
        <Controller
          ...
          render={({ field, fieldState: { error } }) => (
            <FormControl fullWidth>
              <InputLabel id="add-user-subject" shrink>
      ...
      <Grid item xs={12} md={6}>
        <Controller
          ...
          render={({ field, fieldState: { error } }) => (
            <FormControl fullWidth>
              <InputLabel id="add-user-attendanceLecture" shrink>
                {strings.lesson}
              </InputLabel>
              <MuiSelect
                fullWidth
...
export default EditOfflineExam;
